...
# BES
docker build --pull --build-arg TAG=$HYRAX_TAG -t hyrax-bes:$HYRAX_TAG $GIT_URL#:hyrax-${HYRAX_TAG}/besd
docker tag hyrax-bes:$HYRAX_TAG 127.0.0.1:5000/hyrax-bes:$HYRAX_TAG
